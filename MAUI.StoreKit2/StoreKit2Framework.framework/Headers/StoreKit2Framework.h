...
#ifndef STOREKIT2FRAMEWORK_SWIFT_H
#define STOREKIT2FRAMEWORK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="StoreKit2Framework",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC18StoreKit2Framework14PaymentManager") SWIFT_AVAILABILITY(ios,introduced=15.0)
...
SWIFT_PROTOCOL("_TtP18StoreKit2Framework22PaymentManagerDelegate_") SWIFT_AVAILABILITY(ios,introduced=15.0)
@protocol PaymentManagerDelegate
@optional
- (void)paymentManagerDidFinishPurchase:(NSString * _Nonnull)productId transaction:(PaymentTransaction * _Nonnull)transaction;
- (void)paymentManagerDidFailPurchase:(NSString * _Nonnull)productId error:(NSString * _Nonnull)error;
- (void)paymentManagerDidUpdateProducts:(NSArray<PaymentProduct *> * _Nonnull)products;
- (void)paymentManagerDidRestorePurchases:(NSArray<PaymentTransaction *> * _Nonnull)transactions;
- (void)paymentManagerDidDetectStorefrontChange:(StorefrontInfo * _Nonnull)storefront;
- (void)paymentManagerTransactionRevoked:(NSString * _Nonnull)productId reason:(NSString * _Nonnull)reason;
@end

@class NSDecimalNumber;
@class SubscriptionPeriodInfo;
@class SubscriptionOfferInfo;
SWIFT_CLASS("_TtC18StoreKit2Framework14PaymentProduct") SWIFT_AVAILABILITY(ios,introduced=15.0)
...
@property (nonatomic, readonly, strong) SubscriptionPeriodInfo * _Nullable subscriptionPeriod;
@property (nonatomic, readonly, strong) SubscriptionOfferInfo * _Nullable introductoryOffer;
@property (nonatomic, readonly, copy) NSArray<SubscriptionOfferInfo *> * _Nonnull promotionalOffers;
...
@class NSDate;
SWIFT_CLASS("_TtC18StoreKit2Framework18PaymentTransaction") SWIFT_AVAILABILITY(ios,introduced=15.0)
...
@property (nonatomic, readonly, copy) NSString * _Nonnull ownershipType;
@property (nonatomic, readonly, copy) NSString * _Nullable offerType;
...
SWIFT_CLASS("_TtC18StoreKit2Framework14StorefrontInfo") SWIFT_AVAILABILITY(ios,introduced=15.0)
@interface StorefrontInfo : NSObject
@property (nonatomic, readonly, copy) NSString * _Nonnull storefrontId;
@property (nonatomic, readonly, copy) NSString * _Nonnull countryCode;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

SWIFT_CLASS("_TtC18StoreKit2Framework21SubscriptionOfferInfo") SWIFT_AVAILABILITY(ios,introduced=15.0)
@interface SubscriptionOfferInfo : NSObject
@property (nonatomic, readonly, copy) NSString * _Nullable offerId;
@property (nonatomic, readonly, copy) NSString * _Nonnull offerType;
@property (nonatomic, readonly, strong) NSDecimalNumber * _Nonnull price;
@property (nonatomic, readonly, copy) NSString * _Nonnull displayPrice;
@property (nonatomic, readonly, strong) SubscriptionPeriodInfo * _Nonnull period;
...
SWIFT_CLASS("_TtC18StoreKit2Framework22SubscriptionPeriodInfo") SWIFT_AVAILABILITY(ios,introduced=15.0)
...
SWIFT_CLASS("_TtC18StoreKit2Framework23SubscriptionRenewalInfo") SWIFT_AVAILABILITY(ios,introduced=15.0)
@interface SubscriptionRenewalInfo : NSObject
@property (nonatomic, readonly, copy) NSString * _Nonnull originalTransactionId;
@property (nonatomic, readonly, copy) NSString * _Nonnull currentProductId;
@property (nonatomic, readonly) BOOL willAutoRenew;
@property (nonatomic, readonly, copy) NSString * _Nullable autoRenewPreference;
@property (nonatomic, readonly, copy) NSString * _Nullable expirationReason;
@property (nonatomic, readonly) BOOL isInBillingRetry;
@property (nonatomic, readonly, copy) NSDate * _Nullable gracePeriodExpirationDate;
@property (nonatomic, readonly, copy) NSString * _Nullable offerType;
@property (nonatomic, readonly, copy) NSString * _Nullable offerId;
@property (nonatomic, readonly, copy) NSString * _Nonnull priceIncreaseStatus;
@property (nonatomic, readonly, copy) NSString * _Nullable environment;
...
SWIFT_CLASS("_TtC18StoreKit2Framework22SubscriptionStatusInfo") SWIFT_AVAILABILITY(ios,introduced=15.0)
@interface SubscriptionStatusInfo : NSObject
@property (nonatomic, readonly, copy) NSString * _Nonnull state;
@property (nonatomic, readonly, strong) SubscriptionRenewalInfo * _Nullable renewalInfo;
@property (nonatomic, readonly, strong) PaymentTransaction * _Nullable transaction;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
